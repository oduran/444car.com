...
const sendProtectedUser = async () => {
  ...
  async function fetchData() {
    ...
    // You can await here
      let configData = await get(Config.serverUrl + "faq/getallfaqs");
      setUserData(configData.data.result)
